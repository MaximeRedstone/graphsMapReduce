...
//   val reducer = udf {(x: Int, y: ListBuffer[Int]) => reduce_ccf(x, y), MapType(IntegerType, IntegerType) }
  
//   def reduce_ccf_udf(x: Int, y: ListBuffer[Int]): MapType(IntegerType, IntegerType) = { 
//     return reduce_ccf(x, y) 
//   }
